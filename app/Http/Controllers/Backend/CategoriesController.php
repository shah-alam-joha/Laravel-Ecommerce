...
class CategoriesController extends Controller
{
    ...
    [
        'name.required' => 'Please provide a category image',
...
//****** ei nicher code ta run hoy na, bole parameter mistake*****
...
public function delete($id)
{
    ...
    if (!is_null($category)) {
            ...
            // if it is primary or parent category then delete all sub category
   ...
   //  delete only sub category
     ...
     //  end try for delete only sub category
